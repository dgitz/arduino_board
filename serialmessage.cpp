...
/***Created on:2016-12-26 12:25:51.225292***/
/***Target: Raspberry Pi ***/
...
int SerialMessageHandler::encode_Set_DIO_PortSerial(char* outbuffer,int* length,char ShieldID,char PortID,char Pin1_Value,char Pin2_Value,char Pin3_Value,char Pin4_Value,char Pin5_Value,char Pin6_Value,char Pin7_Value,char Pin8_Value)
{
	char *p_outbuffer;
	p_outbuffer = &outbuffer[0];
	*p_outbuffer++ = 0xAB;
